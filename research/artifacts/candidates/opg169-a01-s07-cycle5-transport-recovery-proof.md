...
The committed four-part recovery capsule losslessly stores an 18-file map, including the 805,141-byte Cycle-4 certificate,
decoded SHA-256
...
`audit` checks all four segment hashes, the assembled capsule, all 18 inner file hashes, and the decoded certificate.
