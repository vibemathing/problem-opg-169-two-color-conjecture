...
S=D/'opg169-a01-nine-donor-check-20260908.py'
O=D/'opg169-a01-nine-donor-stdout.json'
E=D/'opg169-a01-nine-donor-stderr.txt'
...
def main():
    ...
    (D/'opg169-a01-nine-donor-execution-20260908.json').write_text(json.dumps(rec,sort_keys=True,indent=2)+'\n')
