"""Bounded C30 candidate replay, not a trusted verifier adapter.
...
SOURCE = PREFIX / 'opg169-a01-c30-dynamic-check.py'
INPUT = PREFIX / 'opg169-a01-c30-dynamic-input.json'
OUTPUT = PREFIX / 'opg169-a01-c30-output.json'
RECORD = PREFIX / 'opg169-a01-c30-execution.json'
...
def main():
    ...
    err = PREFIX / 'opg169-a01-c30-stderr.txt'
